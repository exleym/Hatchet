...
@swag_from('../static/swagger/paths/divisions/create_division.yml')
def create_division():
...
@swag_from('../static/swagger/paths/divisions/list_divisions.yml')
def get_divisions():
...
@swag_from('../static/swagger/paths/divisions/get_division_by_id.yml')
...
@swag_from('../static/swagger/paths/divisions/get_division_members.yml')
...
@swag_from('../static/swagger/paths/divisions/update_division.yml')
...
@swag_from('../static/swagger/paths/divisions/delete_division.yml')
